...
\title[Klein, schön, schnell]{Klein, schön, schnell}


\subtitle{mit Curses den eigenen Scripten eine schöne Oberfläche verleihen}
...
\lyxframeend{}\section{Einführung}


\lyxframeend{}\subsection{Wieso eigentlich?}


\lyxframeend{}\lyxframe{Überschriften sollten informativ sein\\
Korrekte Groß-/Kleinschreibung beachten}


\framesubtitle{Untertitel sind optional}
\begin{itemize}
\item Häufig Auflistungen benutzen.


\pause{}

\item Sehr kurze Sätze oder Phrasen verwenden.
...
\lyxframeend{}\lyxframe{Überschriften müssen informativ sein}
\begin{itemize}
\item <1->Man kann auch Overlay-Spezifikationen benutzen, um Overlays zu
erzeugen.
\item <3->Hiermit können Punkte in beliebiger Reihenfolge präsentiert werden.
...
\lyxframeend{}\subsection{Was ist Curses::UI?}
...
\lyxframeend{}\subsection{Ideen für Beweise/Umsetzung}
...
\item Noch etwas, das wir noch nicht lösen konnten.
\end{itemize}
\end{itemize}
...
\lyxframeend{}\subsection*{Weiterführende Literatur}


\lyxframeend{}\lyxframe{[allowframebreaks]Weiterführende Literatur}

\beamertemplatebookbibitems
\begin{thebibliography}{Literaturverzeichnis}
\bibitem{Autor1990}A. Autor. \newblock \emph{Einführung in das Präsentationswesen}.
